...
class Contests extends Component {
  ...
  getLiveContests = async () => {
    try {
      const res = await axios.get(`https://server.codeium.tech/contest/ongoing`);
  ...
  getUpcomingContests = async () => {
    try {
      const res = await axios.get(`https://server.codeium.tech/contest/upcoming`);
  ...
  getPastContests = async () => {
    try {
      const res = await axios.get(`https://server.codeium.tech/contest/past`);
